...
import './JobDetailsWindow.css';

const JobDetailsWindow = ({ jobId, onClose }) => {
  ...
  if (loading) {
    return (
      <div className="job-details-window">
    ...
    return (
      <div className="job-details-window">
        ...
        <div className="error-state">
          <p>Error: {error}</p>
          <button onClick={fetchJobData} className="retry-btn">
            Retry
          </button>
        </div>
      </div>
...
export default JobDetailsWindow;
